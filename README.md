...
- [ ] Explain what a token is used for.
  ...
  - It's like a key given by the backend at the authentication point that helps it verify if the user has been authenticated

- [ ] What steps can you take in your web apps to keep your data secure?

  - Use SSL (HTTPS) Encryption 
  - Implement a content security policy by defining what content sources are approved.

- [ ] Describe how web servers work.
  
  - When a browser needs a resource which is hosted on a web server, the browser requests the file via HTTP. When the request reaches the correct web server (hardware), the server (software) accepts request, finds the requested document, and sends it back to the browser.
